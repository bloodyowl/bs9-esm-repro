...
build ../linux/bsb$ext:  cc $INCL/bsb.mli $INCL/bsb.ml
    flags = $flags -unboxed-types unix.cmxa str.cmxa
o ../linux/bsb_helper$ext:  cc $INCL/bsb_helper.mli $INCL/bsb_helper.ml
    flags = $flags  -unboxed-types -w -a
o ../linux/refmt$ext: cc $INCL/refmt_main3.mli $INCL/refmt_main3.ml
    flags = $flags  -w -40-30 -no-alias-deps -I +compiler-libs ocamlcommon.cmxa 
o ../linux/bsc$ext: cc $INCL/whole_compiler.mli $INCL/whole_compiler.ml
